...
/*   trim.c                                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: edomingu <edomingu@student.42barc...>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/14 21:26:23 by edomingu          #+#    #+#             */
/*   Updated: 2021/11/14 23:38:17 by vaguilar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <unistd.h>
#include <stdlib.h>
...
void			print_mill(char	*dict, char *num, unsigned int counter,
					unsigned int length);
